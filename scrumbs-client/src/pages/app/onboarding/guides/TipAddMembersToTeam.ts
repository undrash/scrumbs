...
const template = require( "../../../../templates/onboarding-tip-add-members-to-team.html" );





export class TipAddMembersToTeam extends Guide {
    ...
    constructor(parent: Onboarding) {
        super( parent, Guides.TIP_ADD_MEMBERS_TO_TEAM, template );

        this.guide              = this.container.firstElementChild as HTMLElement;

        this.target             = document.querySelector( "#manage-teams-add-member-button" ) as HTMLElement;
