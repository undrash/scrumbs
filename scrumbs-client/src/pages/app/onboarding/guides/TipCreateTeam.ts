...
const template = require( "../../../../templates/onboarding-tip-create-team.html" );





export class TipCreateTeam extends Guide {
    ...
    constructor(parent: Onboarding) {
        super( parent, Guides.TIP_CREATE_TEAM, template );

        this.guide              = this.container.firstElementChild as HTMLElement;

        this.target             = document.querySelector( "#manage-teams-add-new-team-btn" ) as HTMLElement;
    ...
    private setPosition(): void {
        ...
        const offsetX       = this.guide.clientWidth + 20;
        const offsetY       = this.guide.clientHeight - this.target.offsetWidth;
