...
export class ImpedimentSignals {
    public static readonly IMPEDIMENT_SOLVED: string                = "IMPEDIMENT_SOLVED";
    public static readonly IMPEDIMENT_UNSOLVED: string              = "IMPEDIMENT_UNSOLVED";
